...
*16 Sobol-sampled pipe U-bends over all 8 v3 knobs, with `twist_deg`
forced into [10°, 30°] so every case shows visible gradual twist.
Generated by `cli_v2.py --spec specs_v2/sample_sobol_v3_8d_gradual_twist.json`
in ~50 seconds.*

See [`README_v3.md`](./README_v3.md) for the full how-to-generate
walkthrough.
