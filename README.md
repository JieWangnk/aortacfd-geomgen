...
![Validator catches a typo with a "did you mean" hint](figures/cli_validator_typo.png)
...
Once a generated case is run through AortaCFD-app (Blocks B-C of the
workflow), you get full velocity / pressure fields per case:

![Velocity field from a Block-A-generated geometry](figures/branched_aorta_velocity.png)

And after sweeping across N cases (Block D aggregation), the typical
visual deliverable is a sensitivity plot:

![Severity sweep — pressure drop and WSS vs coarctation severity](figures/severity_sweep_demo.png)

*This is the workshop demo's finale figure — 10 cases generated by
this tool, run through AortaCFD-app, aggregated to one CSV, plotted
here.*
